// Pokemon National Dex names - Part 1 of 3 (Gen 1-3, ID 1-386)
// Formatted for clean display: no apostrophes, no periods, no colons, en dashes -> spaces
export const POKEMON_NAMES_GEN_1_3: string[] = [
  "Bulbasaur", "Ivysaur", "Venusaur", "Charmander", "Charmeleon",
  "Charizard", "Squirtle", "Wartortle", "Blastoise", "Caterpie",
  "Metapod", "Butterfree", "Weedle", "Kakuna", "Beedrill",
  "Pidgey", "Pidgeotto", "Pidgeot", "Rattata", "Raticate",
  "Spearow", "Fearow", "Ekans", "Arbok", "Pikachu",
  "Raichu", "Sandshrew", "Sandslash", "Nidoran Female", "Nidorina",
  "Nidoqueen", "Nidoran Male", "Nidorino", "Nidoking", "Clefairy",
...
// Pokemon National Dex names - Part 2 of 3 (Gen 4-6, ID 387-721)
export const POKEMON_NAMES_GEN_4_6: string[] = [
  ...
  "Shaymin", "Arceus", "Victini", "Snivy", "Servine",
  ...
  "Keldeo", "Meloetta", "Genesect", "Chespin", "Quilladin",
  ...
  "Litleo", "Pyroar", "Flabébé", "Floette", "Florges",
  ...
  "Tyrantrum", "Amaura", "Aurorus", "Sylveon", "Hawlucha",
  "Dedenne", "Carbink", "Goomy", "Sliggoo", "Goodra",
  "Klefki", "Phantump", "Trevenant", "Pumpkaboo", "Gourgeist",
  "Bergmite", "Avalugg", "Noibat", "Noivern", "Xerneas",
  "Yveltal", "Zygarde", "Diancie", "Hoopa", "Volcanion",
]

// Pokemon National Dex names - Part 3 of 3 (Gen 7-9, ID 722-1025)
export const POKEMON_NAMES_GEN_7_9: string[] = [
  ...
  "Zeraora", "Meltan", "Melmetal", "Grookey", "Thwackey",
  "Rillaboom", "Scorbunny", "Raboot", "Cinderace", "Sobble",
  "Drizzile", "Inteleon", "Skwovet", "Greedent", "Rookidee",
  "Corvisquire", "Corviknight", "Blipbug", "Dottler", "Orbeetle",
  "Nickit", "Thievul", "Gossifleur", "Eldegoss", "Wooloo",
  "Dubwool", "Chewtle", "Drednaw", "Yamper", "Boltund",
  ...
  "Obstagoon", "Perrserker", "Cursola", "Sirfetchd", "Mr Rime",
  ...
  "Basculegion", "Sneasler", "Overqwil", "Enamorus", "Sprigatito",
  "Floragato", "Meowscarada", "Fuecoco", "Crocalor", "Skeledirge",
  "Quaxly", "Quaxwell", "Quaquaval", "Lechonk", "Oinkologne",
  "Tarountula", "Spidops", "Nymble", "Lokix", "Pawmi",
  "Pawmo", "Pawmot", "Tandemaus", "Maushold", "Fidough",
  "Dachsbun", "Smoliv", "Dolliv", "Arboliva", "Squawkabilly",
  "Nacli", "Naclstack", "Garganacl", "Charcadet", "Armarouge",
  "Ceruledge", "Tadbulb", "Bellibolt", "Wattrel", "Kilowattrel",
  "Maschiff", "Mabosstiff", "Shroodle", "Grafaiai", "Bramblin",
  "Brambleghast", "Toedscool", "Toedscruel", "Klawf", "Capsakid",
  "Scovillain", "Rellor", "Rabsca", "Flittle", "Espathra",
  "Tinkatink", "Tinkatuff", "Tinkaton", "Wiglett", "Wugtrio",
  "Bombirdier", "Finizen", "Palafin", "Varoom", "Revavroom",
  "Cyclizar", "Orthworm", "Glimmet", "Glimmora", "Greavard",
  "Houndstone", "Flamigo", "Cetoddle", "Cetitan", "Veluza",
  ...
  "Arctibax", "Baxcalibur", "Gimmighoul", "Gholdengo", "Wo Chien",
...
// Combined National Dex order, ID 1 (Bulbasaur) to ID 1025 (Pecharunt).
// Index 0 corresponds to Pokemon ID 1.
export const POKEMON_NAMES: string[] = [
  ...POKEMON_NAMES_GEN_1_3,
  ...POKEMON_NAMES_GEN_4_6,
  ...POKEMON_NAMES_GEN_7_9,
]